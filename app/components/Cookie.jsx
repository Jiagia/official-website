...
export function CookieButton({acceptFunc, declineFunc}) {
    return (
        <div>
            <p>This website uses cookies to offer you a better browsing experience. Find out more on how we use cookies and how you can change your settings</p>

            <button type="button" onClick={acceptFunc}>Accept Cookies!</button>
            <button type="button" onClick={declineFunc}>Decline Cookies</button>
        </div>
    )
}
...
export function Toggle2({children}) {
  ...
  return (
    ...
    <label className='themeSwitcherTwo relative inline-flex cursor-pointer select-none items-center'>
        <input
          ...
          className='sr-only'
        />
        {/* <span className='label flex items-center font-medium text-black'>
          Light
        </span> */}
        {children}
        <span
